# Agent S020 — Screen/Checkout/PaymentProcessing
...
|---|---|
| Agent ID | `S020` |
| Design path | `Screen/Checkout/PaymentProcessing` |
| Persian title | در حال پردازش |
| Deck file | `../desighn/_capture/03-04-courses-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/payment_processing_screen.dart` |
| Module | `courses` |
| Note from deck | ارسال مجدد مسدود است |
...
```
2. Locate the block for `Screen/Checkout/PaymentProcessing` / «در حال پردازش».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/payment_processing_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/payment_processing_screen.dart
flutter analyze lib/features/courses/presentation/screens/payment_processing_screen.dart
```
