# Agent S041 — Screen/Investment/Home
...
|---|---|
| Agent ID | `S041` |
| Design path | `Screen/Investment/Home` |
| Persian title | سرمایه‌گذاری (خانه) |
| Deck file | `../desighn/_capture/06-06-investment-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/home_screen.dart` |
| Module | `investment` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Investment/Home` / «سرمایه‌گذاری (خانه)».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/home_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/home_screen.dart
flutter analyze lib/features/investment/presentation/screens/home_screen.dart
```
...
- round">
- حساب
- ۰۱ · سرمایه‌گذاری (خانه)
- Screen/Investment/Home
- ۹:۴۱
- طرح‌های سرمایه‌گذاری
- طرح دریافت ماهیانه ۸٪
- ریسک متوسط
- پرداخت دوره‌ای طبق نرخ اعلام‌شده طرح — جزئیات محاسبه در صفحه قرارداد.
- حداقل مبلغ
- ۱۰٬۰۰۰٬۰۰۰ تومان
- مدت طرح
- مقدار نمونه
...
- ریسک بالا
- مدل بازده: داینامیک — متغیر بر اساس شرایط بازار، بدون نرخ ثابت.
- حداقل مبلغ
- ۵٬۰۰۰٬۰۰۰ تومان
- دوره هولد
- مقدار نمونه
