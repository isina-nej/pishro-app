# Agent S063 — Screen/Market/TopGainers
...
|---|---|
| Agent ID | `S063` |
| Design path | `Screen/Market/TopGainers` |
| Persian title | بیشترین رشد |
| Deck file | `../desighn/_capture/08-07-market.dc.html` |
| Own file (ONLY write here) | `lib/features/market/presentation/screens/top_gainers_screen.dart` |
| Module | `market` |
| Note from deck | #24C486 |
...
```
2. Locate the block for `Screen/Market/TopGainers` / «بیشترین رشد».
...
### Phase 2 — Scaffold
1. Create `lib/features/market/presentation/screens/top_gainers_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Market/TopGainers — «بیشترین رشد».`
...
### Phase 5 — Verify
```bash
dart format lib/features/market/presentation/screens/top_gainers_screen.dart
flutter analyze lib/features/market/presentation/screens/top_gainers_screen.dart
```
...
- ۰۶ · بیشترین کاهش
- Screen/Market/TopLosers · #F05B67
- ۹:۴۱
- نام ارز یا نماد آن را جستجو کنید
- انصراف
- جستجوهای اخیر
- Bitcoin
- ETH
...
- SOL
- ۰۷ · جستجوی ارز
- Screen/Market/Search · فارسی + لاتین
- <div
