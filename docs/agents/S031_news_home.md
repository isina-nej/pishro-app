...
|---|---|
| Agent ID | `S031` |
| Design path | `Screen/News/Home` |
| Persian title | اخبار (خانه) |
| Deck file | `../desighn/_capture/05-05-news.dc.html` |
| Own file (ONLY write here) | `lib/features/news/presentation/screens/home_screen.dart` |
| Module | `news` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/News/Home` / «اخبار (خانه)».
...
### Phase 2 — Scaffold
1. Create `lib/features/news/presentation/screens/home_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/News/Home — «اخبار (خانه)».`
...
### Phase 5 — Verify
```bash
dart format lib/features/news/presentation/screens/home_screen.dart
flutter analyze lib/features/news/presentation/screens/home_screen.dart
```
...
- این ماه
- ۱
- تحلیل روند بازار ارز دیجیتال در هفته اخیر
- ۱۲٬۴۰۰ بازدید نمونه · ۲۸ دیدگاه
- ۲
- گزارش هفتگی شاخص بورس تهران
- ۸٬۹۰۰ بازدید نمونه · ۱۴ دیدگاه
- ۳
- تأثیر نرخ بهره جهانی بر بازارهای نوظهور
- ۶٬۲۰۰ بازدید نمونه · ۹ دیدگاه
- تعداد بازدید نمونه است و از داده واقعی پشتیبان تأمین نشده
- ۰۲ · پربازدید
- Screen/News/Trending
- ۹:۴۱
- دسته‌بندی اخبار
- ارز دیجیتال
- ۱۲۴ خبر · آخرین: نوسان بازار امروز
- اقتصاد ایران
- ۸۶ خبر · آخرین: گزارش تورم ماهانه
- <svg width="19" height="19" viewBox="0 0 24 24" f
