# Agent S056 — Screen/Investment/ActiveInvestments
...
|---|---|
| Agent ID | `S056` |
| Design path | `Screen/Investment/ActiveInvestments` |
| Persian title | سرمایه‌گذاری‌های من |
| Deck file | `../desighn/_capture/07-06-investment-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/active_investments_screen.dart` |
| Module | `investment` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Investment/ActiveInvestments` / «سرمایه‌گذاری‌های من».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/active_investments_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/active_investments_screen.dart
flutter analyze lib/features/investment/presentation/screens/active_investments_screen.dart
```
...
- round">
- حساب
- ۰۸ · سرمایه‌گذاری‌های من
- Screen/Investment/ActiveInvestments
- 06_INVESTMENT
- صفحه ۰۹–۱۰
- دریافت ماهیانه ۸٪
- فعال
