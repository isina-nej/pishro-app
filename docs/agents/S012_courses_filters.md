# Agent S012 — Screen/Courses/Filters
...
|---|---|
| Agent ID | `S012` |
| Design path | `Screen/Courses/Filters` |
| Persian title | فیلترها |
| Deck file | `../desighn/_capture/02-04-courses-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/filters_screen.dart` |
| Module | `courses` |
| Note from deck | Bottom Sheet |
...
```
2. Locate the block for `Screen/Courses/Filters` / «فیلترها».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/filters_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/filters_screen.dart
flutter analyze lib/features/courses/presentation/screens/filters_screen.dart
```
...
- ۰۳ · فیلترها
- Screen/Courses/Filters · Bottom Sheet
- 04_COURSES
- صفحه ۰۴–۰۶ · نتایج، جزئیات دوره و مقایسه بسته
- ۹:۴۱
- نتایج دوره‌ها
- «تحلیل تکنیکال» · ۴۸ نتیجه
- صافی
- ۲
- مرتب‌سازی
- عادی
...
- تیم آموزشی پیشرو سرمایه · مقدماتی
- ★ ۴٫۸
- ·
- ۱٬۲۴۰ دانشجو
- ·
...
- ۱٬۹۹۰٬۰۰۰
- تومان
- <div style="width: 92px; height: 92px; borde
