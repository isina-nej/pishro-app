# Agent S029 — Screen/Course/Completion
...
|---|---|
| Agent ID | `S029` |
| Design path | `Screen/Course/Completion` |
| Persian title | تکمیل دوره |
| Deck file | `../desighn/_capture/04-04-courses-part-3.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/completion_screen.dart` |
| Module | `courses` |
...
```
2. Locate the block for `Screen/Course/Completion` / «تکمیل دوره».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/completion_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Course/Completion — «تکمیل دوره».`
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/completion_screen.dart
flutter analyze lib/features/courses/presentation/screens/completion_screen.dart
```
