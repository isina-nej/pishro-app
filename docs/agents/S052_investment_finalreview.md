# Agent S052 — Screen/Investment/FinalReview
...
|---|---|
| Agent ID | `S052` |
| Design path | `Screen/Investment/FinalReview` |
| Persian title | مرور نهایی |
| Deck file | `../desighn/_capture/07-06-investment-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/final_review_screen.dart` |
| Module | `investment` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Investment/FinalReview` / «مرور نهایی».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/final_review_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Investment/FinalReview — «مرور نهایی».`
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/final_review_screen.dart
flutter analyze lib/features/investment/presentation/screens/final_review_screen.dart
```
