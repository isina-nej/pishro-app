# Agent S075 — Screen/Community/Search
...
|---|---|
| Agent ID | `S075` |
| Design path | `Screen/Community/Search` |
| Persian title | جستجو در جامعه |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/search_screen.dart` |
| Module | `community` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Community/Search` / «جستجو در جامعه».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/search_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/search_screen.dart
flutter analyze lib/features/community/presentation/screens/search_screen.dart
```
...
- ثبت امتیاز
- ۰۷ · امتیازها و نظرات
- Screen/Community/AnalystRatings</di
