# Agent S017 — Screen/Checkout/Course-VIP
...
|---|---|
| Agent ID | `S017` |
| Design path | `Screen/Checkout/Course-VIP` |
| Persian title | پرداخت بسته VIP |
| Deck file | `../desighn/_capture/02-04-courses-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/course__v_i_p_screen.dart` |
| Module | `courses` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Checkout/Course-VIP` / «پرداخت بسته VIP».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/course__v_i_p_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/course__v_i_p_screen.dart
flutter analyze lib/features/courses/presentation/screens/course__v_i_p_screen.dart
```
...
- ۰۸ · پرداخت بسته VIP
- Screen/Checkout/Course-VIP
- 10_SHARED_STATES
- ۶ فریم حالت جانبی — شمرده نمی‌شوند به‌عنوان صفحه اصلی محصول
- تکمیل خرید
- برای ادامه، پذیرش قوانین خرید الزامی است.
- تحلیل تکنیکال از صفر تا معامله‌گری · بسته عادی
- مبلغ قابل پرداخت
- ۲٬۴۹۰٬۰۰۰ تومان
- قوانین خرید و شرایط استفاده از دوره را مطالعه کرده‌ام و می‌پذیرم.
- پرداخت ۲٬۴۹۰٬۰۰۰ تومان
- خطای اعتبارسنجی — عادی
- Course-Regular-ValidationError
- تکمیل خرید VIP
- برای ادامه، پذیرش قوانین خرید الزامی است.
- تحلیل تکنیکال · بسته VIP
- مبلغ قابل پرداخت
- ۴٬۹۹۰٬۰۰۰ تومان
- قوانین خرید و شرایط استفاده از دوره را مطالعه کرده‌ام و می‌پذیرم.
- پرداخت ۴٬۹۹۰٬۰۰۰ تومان
- خطای اعتبارسنجی — VIP
- Course-VIP-ValidationError
- تکمیل خرید
