# Agent S082 — Screen/Community/AnalysisEditor
...
|---|---|
| Agent ID | `S082` |
| Design path | `Screen/Community/AnalysisEditor` |
| Persian title | ویرایشگر تحلیل |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/analysis_editor_screen.dart` |
| Module | `community` |
| Note from deck | نوار ابزار پایین قابل‌اسکرول |
...
```
2. Locate the block for `Screen/Community/AnalysisEditor` / «ویرایشگر تحلیل».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/analysis_editor_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/analysis_editor_screen.dart
flutter analyze lib/features/community/presentation/screens/analysis_editor_screen.dart
```
...
- dth="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#D9DEE3" stroke-width="1.8">
- ۱۲ · ویرایشگر تحلیل
- Screen/Community/AnalysisEditor · نوار ابزار پایین قابل‌اسکرول
- 08_COMMUNITY
- صفحه ۱۳–۱۴
- این صفحه پیش‌نمایش است و هنوز منتشر نشده است.
- شما (نام کاربر نمونه)
...
- انتشار تحلیل
- ۱۳ · پیش‌نمایش تحلیل
- Screen/Community/AnalysisPreview
- تحلیل منتشر شد
- عنوان
- بررسی سطوح حمایت...
- زمان انتشار
...
- 08_COMMUNITY
- Overlay مصور
- <div style="width: 332px; height: 720px; background: #080A0D; border-radius: 34px; overflo
