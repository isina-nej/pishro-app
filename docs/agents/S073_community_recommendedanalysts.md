# Agent S073 — Screen/Community/RecommendedAnalysts
...
|---|---|
| Agent ID | `S073` |
| Design path | `Screen/Community/RecommendedAnalysts` |
| Persian title | تحلیلگران پیشنهادی |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/recommended_analysts_screen.dart` |
| Module | `community` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Community/RecommendedAnalysts` / «تحلیلگران پیشنهادی».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/recommended_analysts_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/recommended_analysts_screen.dart
flutter analyze lib/features/community/presentation/screens/recommended_analysts_screen.dart
```
...
- : 36px; display: flex; align-items: center;">دنبال کردن
...
- پیشنهادی
- تحلیلگر نمونه ۴
- <div style="font-size: 14px; font-weight: 600; color: #D9DEE3
