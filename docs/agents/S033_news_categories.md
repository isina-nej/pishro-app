# Agent S033 — Screen/News/Categories
...
|---|---|
| Agent ID | `S033` |
| Design path | `Screen/News/Categories` |
| Persian title | دسته‌بندی |
| Deck file | `../desighn/_capture/05-05-news.dc.html` |
| Own file (ONLY write here) | `lib/features/news/presentation/screens/categories_screen.dart` |
| Module | `news` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/News/Categories` / «دسته‌بندی».
...
### Phase 2 — Scaffold
1. Create `lib/features/news/presentation/screens/categories_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/News/Categories — «دسته‌بندی».`
...
### Phase 5 — Verify
```bash
dart format lib/features/news/presentation/screens/categories_screen.dart
flutter analyze lib/features/news/presentation/screens/categories_screen.dart
```
