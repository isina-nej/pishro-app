# Agent S064 — Screen/Market/TopLosers
...
|---|---|
| Agent ID | `S064` |
| Design path | `Screen/Market/TopLosers` |
| Persian title | بیشترین کاهش |
| Deck file | `../desighn/_capture/08-07-market.dc.html` |
| Own file (ONLY write here) | `lib/features/market/presentation/screens/top_losers_screen.dart` |
| Module | `market` |
| Note from deck | #F05B67 |
...
```
2. Locate the block for `Screen/Market/TopLosers` / «بیشترین کاهش».
...
### Phase 2 — Scaffold
1. Create `lib/features/market/presentation/screens/top_losers_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/market/presentation/screens/top_losers_screen.dart
flutter analyze lib/features/market/presentation/screens/top_losers_screen.dart
```
