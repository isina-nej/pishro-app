# Agent S069 — Screen/Market/HistoricalData
...
|---|---|
| Agent ID | `S069` |
| Design path | `Screen/Market/HistoricalData` |
| Persian title | داده‌های تاریخی |
| Deck file | `../desighn/_capture/08-07-market.dc.html` |
| Own file (ONLY write here) | `lib/features/market/presentation/screens/historical_data_screen.dart` |
| Module | `market` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Market/HistoricalData` / «داده‌های تاریخی».
...
### Phase 2 — Scaffold
1. Create `lib/features/market/presentation/screens/historical_data_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/market/presentation/screens/historical_data_screen.dart
flutter analyze lib/features/market/presentation/screens/historical_data_screen.dart
```
