# Agent S055 — Screen/Investment/Success
...
|---|---|
| Agent ID | `S055` |
| Design path | `Screen/Investment/Success` |
| Persian title | موفقیت (فعال‌شده) |
| Deck file | `../desighn/_capture/07-06-investment-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/success_screen.dart` |
| Module | `investment` |
...
```
2. Locate the block for `Screen/Investment/Success` / «موفقیت (فعال‌شده)».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/success_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/success_screen.dart
flutter analyze lib/features/investment/presentation/screens/success_screen.dart
```
...
- ntent: center;">مشاهده جزئیات سرمایه‌گذاری
