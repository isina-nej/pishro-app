# Agent S010 — Screen/Courses/Categories
...
|---|---|
| Agent ID | `S010` |
| Design path | `Screen/Courses/Categories` |
| Persian title | دسته‌بندی‌ها |
| Deck file | `../desighn/_capture/02-04-courses-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/categories_screen.dart` |
| Module | `courses` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Courses/Categories` / «دسته‌بندی‌ها».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/categories_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Courses/Categories — «دسته‌بندی‌ها».`
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/categories_screen.dart
flutter analyze lib/features/courses/presentation/screens/categories_screen.dart
```
