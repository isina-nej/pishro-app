# Agent S011 — Screen/Courses/Search
...
|---|---|
| Agent ID | `S011` |
| Design path | `Screen/Courses/Search` |
| Persian title | جست‌وجو |
| Deck file | `../desighn/_capture/02-04-courses-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/search_screen.dart` |
| Module | `courses` |
| Note from deck | کیبورد باز |
...
```
2. Locate the block for `Screen/Courses/Search` / «جست‌وجو».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/search_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/search_screen.dart
flutter analyze lib/features/courses/presentation/screens/search_screen.dart
```
...
- ۰۲ · جست‌وجو
- Screen/Courses/Search · کیبورد باز
- فیلتر دوره‌ها
- نوع بسته
- همه
- عادی
