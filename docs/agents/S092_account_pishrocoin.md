# Agent S092 — Screen/Account/PishroCoin
...
|---|---|
| Agent ID | `S092` |
| Design path | `Screen/Account/PishroCoin` |
| Persian title | کوین پیشرو |
| Deck file | `../desighn/_capture/10-09-account-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/account/presentation/screens/pishro_coin_screen.dart` |
| Module | `account` |
| Note from deck | بدون نرخ تبدیل |
...
```
2. Locate the block for `Screen/Account/PishroCoin` / «کوین پیشرو».
...
### Phase 2 — Scaffold
1. Create `lib/features/account/presentation/screens/pishro_coin_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Account/PishroCoin — «کوین پیشرو».`
...
### Phase 5 — Verify
```bash
dart format lib/features/account/presentation/screens/pishro_coin_screen.dart
flutter analyze lib/features/account/presentation/screens/pishro_coin_screen.dart
```
...
- مشاهده قوانین استفاده از کوین
- ۰۸ · کوین پیشرو
- Screen/Account/PishroCoin · بدون نرخ تبدیل
- 09_ACCOUNT
- صفحه ۰۹–۱۰
- سوابق خرید
- همه
- دوره‌ها
- اشتراک‌ها
- تحلیل تکنیکال از صفر
- پرداخت‌شده
- دوره VIP · ۶ مرداد ۱۴۰۵ · ORD-9931
- ۴٬۹۹۰٬۰۰۰ تومان
- دسترسی: فعال
- اشتراک تحلیلگر نمونه ۲
- در انتظار پرداخت
- اشتراک ماهانه · ۵ مرداد ۱۴۰۵ · ORD-9928
- ۴۹۰٬۰۰۰ تومان
