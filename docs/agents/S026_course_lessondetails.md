# Agent S026 — Screen/Course/LessonDetails
...
|---|---|
| Agent ID | `S026` |
| Design path | `Screen/Course/LessonDetails` |
| Persian title | جزئیات جلسه |
| Deck file | `../desighn/_capture/04-04-courses-part-3.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/lesson_details_screen.dart` |
| Module | `courses` |
| Note from deck | دانلود و تکمیل تعاملی |
...
```
2. Locate the block for `Screen/Course/LessonDetails` / «جزئیات جلسه».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/lesson_details_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/lesson_details_screen.dart
flutter analyze lib/features/courses/presentation/screens/lesson_details_screen.dart
```
...
- >جلسه بعدی
- ۰۱ · جزئیات جلسه
- Screen/Course/LessonDetails · دانلود و تکمیل تعاملی
- ۹:۴۱
- دانلودها و منابع
- دانلودهای جلسات
- ۳ از ۱۲ دانلودشده
...
- حجم اشغال‌شده: ۴۲۰ مگابایت از فضای دستگاه
- ۰۲ · دانلودها و منابع
- Screen/Course/DownloadsAndResources
- ۹:۴۱
- <div style="width: 44px; height: 44px; border-radius: 12px; display: grid; pla
