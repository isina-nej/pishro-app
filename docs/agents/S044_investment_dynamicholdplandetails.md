# Agent S044 — Screen/Investment/DynamicHoldPlanDetails
...
|---|---|
| Agent ID | `S044` |
| Design path | `Screen/Investment/DynamicHoldPlanDetails` |
| Persian title | طرح هولد داینامیک |
| Deck file | `../desighn/_capture/06-06-investment-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/dynamic_hold_plan_details_screen.dart` |
| Module | `investment` |
| Note from deck | بدون درصد اختراعی |
...
```
2. Locate the block for `Screen/Investment/DynamicHoldPlanDetails` / «طرح هولد داینامیک».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/dynamic_hold_plan_details_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/dynamic_hold_plan_details_screen.dart
flutter analyze lib/features/investment/presentation/screens/dynamic_hold_plan_details_screen.dart
```
