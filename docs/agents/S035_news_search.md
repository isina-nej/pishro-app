...
|---|---|
| Agent ID | `S035` |
| Design path | `Screen/News/Search` |
| Persian title | جستجو |
| Deck file | `../desighn/_capture/05-05-news.dc.html` |
| Own file (ONLY write here) | `lib/features/news/presentation/screens/search_screen.dart` |
| Module | `news` |
| Note from deck | فوکوس خودکار |
...
```
2. Locate the block for `Screen/News/Search` / «جستجو».
...
### Phase 2 — Scaffold
1. Create `lib/features/news/presentation/screens/search_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/news/presentation/screens/search_screen.dart
flutter analyze lib/features/news/presentation/screens/search_screen.dart
```
...
- #242B33; color: #B6BEC6; font-size: 12px; padding: 8px 13px; border-radius: 999px;">بورس
- ۰۵ · جستجو
- Screen/News/Search · فوکوس خودکار
- 05_NEWS
- صفحه ۰۶–۱۰
- ۹:۴۱
- نتایج اخبار
...
- جدیدترین
- ارز دیجیتال ✕
- تحلیل روند بیت‌کوین در معاملات هفته جاری
- ارز دیجیتال · ۳ ساعت پیش · ۱۸ دیدگاه
- مقایسه عملکرد بیت‌کوین و اتریوم در سه ماه اخیر
- ارز دیجیتال · دیروز · ۷ دیدگاه
- واکنش بازار به تصمیمات اخیر تنظیم‌گران
- ارز دیجیتال · ۲ روز پیش · ۴ دیدگاه
