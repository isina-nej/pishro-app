# Agent S078 — Screen/Community/AnalysisDetails
...
|---|---|
| Agent ID | `S078` |
| Design path | `Screen/Community/AnalysisDetails` |
| Persian title | جزئیات تحلیل |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/analysis_details_screen.dart` |
| Module | `community` |
| Note from deck | سناریوهای هم‌وزن |
...
```
2. Locate the block for `Screen/Community/AnalysisDetails` / «جزئیات تحلیل».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/analysis_details_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/analysis_details_screen.dart
flutter analyze lib/features/community/presentation/screens/analysis_details_screen.dart
```
...
- #8D97A2; line-height: 1.8;">این محتوا دیدگاه نویسنده است و توصیه قطعی برای خرید یا فروش محسوب نمی‌شود.
- ۰۸ · جزئیات تحلیل
...
- مشاهده محتوا
- ۱۰ · اشتراک‌های من
- <div style="font-family: 'IBM Plex Mono', monospace; font-siz
