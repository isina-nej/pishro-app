# Agent S032 — Screen/News/Trending
...
|---|---|
| Agent ID | `S032` |
| Design path | `Screen/News/Trending` |
| Persian title | پربازدید |
| Deck file | `../desighn/_capture/05-05-news.dc.html` |
| Own file (ONLY write here) | `lib/features/news/presentation/screens/trending_screen.dart` |
| Module | `news` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/News/Trending` / «پربازدید».
...
### Phase 2 — Scaffold
1. Create `lib/features/news/presentation/screens/trending_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/News/Trending — «پربازدید».`
...
### Phase 5 — Verify
```bash
dart format lib/features/news/presentation/screens/trending_screen.dart
flutter analyze lib/features/news/presentation/screens/trending_screen.dart
```
...
- بازارهای جهانی
- ۶۵ خبر · آخرین: جمع‌بندی هفتگی شاخص‌ها
- تحلیل بازار
- ۴۱ خبر · آخرین: بررسی روند هفتگی
- فناوری مالی
- ۲۹ خبر · آخرین: تحلیل اختصاصی هفته
- ۰۳ · دسته‌بندی
- Screen/News/Categories
- فیلتر اخبار
- پاک کردن همه
- زمان انتشار
- امروز
