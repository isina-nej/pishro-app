# Agent S072 — Screen/Community/FollowingFeed
...
|---|---|
| Agent ID | `S072` |
| Design path | `Screen/Community/FollowingFeed` |
| Persian title | دنبال‌شده‌ها |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/following_feed_screen.dart` |
| Module | `community` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Community/FollowingFeed` / «دنبال‌شده‌ها».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/following_feed_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/following_feed_screen.dart
flutter analyze lib/features/community/presentation/screens/following_feed_screen.dart
```
...
- 08_COMMUNITY
- <span style="width: 4px; height: 4px; border-radius: 999px; background:
