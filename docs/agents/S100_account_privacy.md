# Agent S100 — Screen/Account/Privacy
...
|---|---|
| Agent ID | `S100` |
| Design path | `Screen/Account/Privacy` |
| Persian title | حریم خصوصی |
| Deck file | `../desighn/_capture/11-09-account-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/account/presentation/screens/privacy_screen.dart` |
| Module | `account` |
| Note from deck | رضایت‌ها مجزا و بدون پیش‌انتخاب |
...
```
2. Locate the block for `Screen/Account/Privacy` / «حریم خصوصی».
...
### Phase 2 — Scaffold
1. Create `lib/features/account/presentation/screens/privacy_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/account/presentation/screens/privacy_screen.dart
flutter analyze lib/features/account/presentation/screens/privacy_screen.dart
```
...
- 2; margin-top: 4px; line-height: 1.8;">این عملیات بلافاصله انجام نمی‌شود و نیازمند بررسی خدمات فعال است.
- ۱۶ · حریم خصوصی
- Screen/Account/Privacy · رضایت‌ها مجزا و بدون پیش‌انتخاب
- پشتیبانی
- جستجو در مقالات راهنما
- احراز هویت
- پرداخت
- دوره‌ها
- مسائل امنیتی فوری
...
- ثبت درخواست جدید
- ۱۷ · پشتیبانی
- Screen/Account/Support · بدون ساعت/شماره اختراعی
- معرفی به دوستان
- کد معرف شما
- PS-USR294
- کپی
...
- پاداش ثبت‌شده
- ۱
- جزئیات پاداش طبق قوانین جاری برنامه محاسبه می‌شود.
- برای جلوگیری از سوءاستفاده، دعوت‌های مشکوک بررسی و ممکن است رد شوند.
- ۱۸ · معرفی به دوستان
