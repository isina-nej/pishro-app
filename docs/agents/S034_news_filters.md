# Agent S034 — Screen/News/Filters
...
|---|---|
| Agent ID | `S034` |
| Design path | `Screen/News/Filters` |
| Persian title | فیلتر |
| Deck file | `../desighn/_capture/05-05-news.dc.html` |
| Own file (ONLY write here) | `lib/features/news/presentation/screens/filters_screen.dart` |
| Module | `news` |
| Note from deck | بدون ناوبری پایین |
...
```
2. Locate the block for `Screen/News/Filters` / «فیلتر».
...
### Phase 2 — Scaffold
1. Create `lib/features/news/presentation/screens/filters_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/news/presentation/screens/filters_screen.dart
flutter analyze lib/features/news/presentation/screens/filters_screen.dart
```
...
- ۰۴ · فیلتر
- Screen/News/Filters · بدون ناوبری پایین
- ۹:۴۱
- عنوان خبر، موضوع یا کلیدواژه…
- انصراف
- جستجوهای اخیر
- پاک کردن
- بیت‌کوین
...
- <div style="background: #14181D; border: 1p
