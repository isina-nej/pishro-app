# Agent S080 — Screen/Community/Subscriptions
...
|---|---|
| Agent ID | `S080` |
| Design path | `Screen/Community/Subscriptions` |
| Persian title | اشتراک‌های من |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/subscriptions_screen.dart` |
| Module | `community` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Community/Subscriptions` / «اشتراک‌های من».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/subscriptions_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/subscriptions_screen.dart
flutter analyze lib/features/community/presentation/screens/subscriptions_screen.dart
```
...
- : #D9DEE3; font-size: 10px; padding: 8px; border-radius: 8px; text-align: center;">مشاهده محتوا
- ۱۰ · اشتراک‌های من
...
- ۱۲۰ نویسه
- B
- <div style="width: 36px; height: 36px; border-radius: 8px; background: #14181D; disp
