# Agent S076 — Screen/Community/AnalystProfile
...
|---|---|
| Agent ID | `S076` |
| Design path | `Screen/Community/AnalystProfile` |
| Persian title | پروفایل تحلیلگر |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/analyst_profile_screen.dart` |
| Module | `community` |
| Note from deck | نشان‌های جدا |
...
```
2. Locate the block for `Screen/Community/AnalystProfile` / «پروفایل تحلیلگر».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/analyst_profile_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Community/AnalystProfile — «پروفایل تحلیلگر».`
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/analyst_profile_screen.dart
flutter analyze lib/features/community/presentation/screens/analyst_profile_screen.dart
```
...
- ۰۶ · پروفایل تحلیلگر
- Screen/Community/AnalystProfile · نشان‌های جدا
- امتیازها و نظرات
- ۴٫۶
- ★★★★★
- ۸۴ نظر
...
- <div style="flex: none; padding: 10
