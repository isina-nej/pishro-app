# Agent S021 — Screen/Checkout/PaymentSuccess
...
|---|---|
| Agent ID | `S021` |
| Design path | `Screen/Checkout/PaymentSuccess` |
| Persian title | پرداخت موفق |
| Deck file | `../desighn/_capture/03-04-courses-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/payment_success_screen.dart` |
| Module | `courses` |
...
```
2. Locate the block for `Screen/Checkout/PaymentSuccess` / «پرداخت موفق».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/payment_success_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Checkout/PaymentSuccess — «پرداخت موفق».`
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/payment_success_screen.dart
flutter analyze lib/features/courses/presentation/screens/payment_success_screen.dart
```
