# Agent S003 — Screen/Auth/Onboarding-01
...
|---|---|
| Agent ID | `S003` |
| Design path | `Screen/Auth/Onboarding-01` |
| Persian title | آشنایی ۱ |
| Deck file | `../desighn/_capture/01-03-auth.dc.html` |
| Own file (ONLY write here) | `lib/features/auth/presentation/screens/onboarding_01_screen.dart` |
| Module | `auth` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Auth/Onboarding-01` / «آشنایی ۱».
...
### Phase 2 — Scaffold
1. Create `lib/features/auth/presentation/screens/onboarding_01_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/auth/presentation/screens/onboarding_01_screen.dart
flutter analyze lib/features/auth/presentation/screens/onboarding_01_screen.dart
```
...
- نمونه
- بازار و تحلیل
- قیمت ارزها، داده‌های بازار و تحلیل کاربران حرفه‌ای را دنبال کنید.
- ۲ / ۳
- ادامه
- ۰۴ · آشنایی ۲
