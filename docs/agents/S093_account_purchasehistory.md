# Agent S093 — Screen/Account/PurchaseHistory
...
|---|---|
| Agent ID | `S093` |
| Design path | `Screen/Account/PurchaseHistory` |
| Persian title | سوابق خرید |
| Deck file | `../desighn/_capture/10-09-account-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/account/presentation/screens/purchase_history_screen.dart` |
| Module | `account` |
| Note from deck | دسترسی جدا از پرداخت |
...
```
2. Locate the block for `Screen/Account/PurchaseHistory` / «سوابق خرید».
...
### Phase 2 — Scaffold
1. Create `lib/features/account/presentation/screens/purchase_history_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/account/presentation/screens/purchase_history_screen.dart
flutter analyze lib/features/account/presentation/screens/purchase_history_screen.dart
```
...
- ۰۹ · سوابق خرید
- Screen/Account/PurchaseHistory · دسترسی جدا از پرداخت
- سوابق سرمایه‌گذاری
- همه
- فعال
- در انتظار
...
- دریافت ماهیانه ۸٪
- فعال
- مبلغ: ۵۰٬۰۰۰٬۰۰۰ تومان · فعال‌سازی: ۶ مرداد · INV-88213
- هولد داینامیک
- در انتظار فعال‌سازی
- مبلغ: ۲۰٬۰۰۰٬۰۰۰ تومان · ثبت: ۴ مرداد · REQ-3021
- داده بازده ثبت‌شده در دسترس نیست.
- ۱۰ · سوابق سرمایه‌گذاری
- Screen/Account/InvestmentHistory
- 09_ACCOUNT
- Overlay مصور
- نمایش اطلاعات حساس
- رمز عبور یا اثر انگشت
- تأیید و نمایش
- نمایش اطلاعات حساس
- Overlay/Account/RevealSensitiveInformation
- تأیید ارسال مدارک
- اطلاعات هویتی
- تکمیل‌شده
- تعداد مدارک آپلودشده
- ۲ فایل
- موارد ناقص
- حساب بانکی
- اطلاعات شما برای بررسی ارسال می‌شود و ممکن است چند روز کاری زمان ببرد.
- ارسال برای بررسی
- تأیید ارسال احراز هویت
- <div style="font-family: 'IBM Plex Mono', mono
