# Agent S094 — Screen/Account/InvestmentHistory
...
|---|---|
| Agent ID | `S094` |
| Design path | `Screen/Account/InvestmentHistory` |
| Persian title | سوابق سرمایه‌گذاری |
| Deck file | `../desighn/_capture/10-09-account-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/account/presentation/screens/investment_history_screen.dart` |
| Module | `account` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Account/InvestmentHistory` / «سوابق سرمایه‌گذاری».
...
### Phase 2 — Scaffold
1. Create `lib/features/account/presentation/screens/investment_history_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/account/presentation/screens/investment_history_screen.dart
flutter analyze lib/features/account/presentation/screens/investment_history_screen.dart
```
...
- Overlay/Account/KYCSubmissionConfirmation
- قوانین کوین پیشرو
- • تخفیف خرید دوره
- • ارتقای سطح کاربری
- • دسترسی به محتوای ویژه
- قوانین کوین
- Overlay/Account/PishroCoinRules
- 10_SHARED_STATES
