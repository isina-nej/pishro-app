# Agent S013 — Screen/Courses/SearchResults
...
|---|---|
| Agent ID | `S013` |
| Design path | `Screen/Courses/SearchResults` |
| Persian title | نتایج جست‌وجو |
| Deck file | `../desighn/_capture/02-04-courses-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/search_results_screen.dart` |
| Module | `courses` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Courses/SearchResults` / «نتایج جست‌وجو».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/search_results_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/search_results_screen.dart
flutter analyze lib/features/courses/presentation/screens/search_results_screen.dart
```
...
- مدرس
- نظرات
- در این دوره با ساختار بازارهای مالی، خواندن نمودار و مدیریت ریسک معاملاتی به‌صورت گام‌به‌گام آشنا می‌شوید.
- خروجی‌های یادگیری
- خواندن نمودار قیمت و شناسایی روند
- تعیین حد سود و حد ضرر در معاملات
- مدیریت حجم موقعیت متناسب با سرمایه
- سرفصل‌ها
