# Agent S019 — Screen/Checkout/DiscountAndCoin
...
|---|---|
| Agent ID | `S019` |
| Design path | `Screen/Checkout/DiscountAndCoin` |
| Persian title | تخفیف و کوین |
| Deck file | `../desighn/_capture/03-04-courses-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/discount_and_coin_screen.dart` |
| Module | `courses` |
| Note from deck | کلید کوین را بزنید |
...
```
2. Locate the block for `Screen/Checkout/DiscountAndCoin` / «تخفیف و کوین».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/discount_and_coin_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/discount_and_coin_screen.dart
flutter analyze lib/features/courses/presentation/screens/discount_and_coin_screen.dart
```
...
- ۰۲ · تخفیف و کوین
- Screen/Checkout/DiscountAndCoin · کلید کوین را بزنید
...
- 04_COURSES
- صفحه ۰۴–۰۶ · نتیجه پرداخت و دوره‌های من — تب‌ها تعاملی‌اند
- ۹:۴۱
...
- <div style="width: 390px; height: 844px; background: #080A0D; border-radius: 40px; overflow
