# Agent S050 — Screen/Investment/AmountEntry
...
|---|---|
| Agent ID | `S050` |
| Design path | `Screen/Investment/AmountEntry` |
| Persian title | مبلغ سرمایه‌گذاری |
| Deck file | `../desighn/_capture/07-06-investment-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/amount_entry_screen.dart` |
| Module | `investment` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Investment/AmountEntry` / «مبلغ سرمایه‌گذاری».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/amount_entry_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/amount_entry_screen.dart
flutter analyze lib/features/investment/presentation/screens/amount_entry_screen.dart
```
...
- همه تراکنش‌ها از طریق مسیر امن پرداخت انجام می‌شود.
- ادامه با روش انتخاب‌شده
- ۰۳ · منبع تأمین وجه
