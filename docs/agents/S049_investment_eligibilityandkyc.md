# Agent S049 — Screen/Investment/EligibilityAndKYC
...
|---|---|
| Agent ID | `S049` |
| Design path | `Screen/Investment/EligibilityAndKYC` |
| Persian title | احراز شرایط |
| Deck file | `../desighn/_capture/07-06-investment-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/eligibility_and_k_y_c_screen.dart` |
| Module | `investment` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Investment/EligibilityAndKYC` / «احراز شرایط».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/eligibility_and_k_y_c_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/eligibility_and_k_y_c_screen.dart
flutter analyze lib/features/investment/presentation/screens/eligibility_and_k_y_c_screen.dart
```
...
- ۰۱ · احراز شرایط
- Screen/Investment/EligibilityAndKYC
- مبلغ سرمایه‌گذاری
- طرح: دریافت ماهیانه ۸٪ · حداقل ۱۰٬۰۰۰٬۰۰۰ تومان
- ۵۰٬۰۰۰٬۰۰۰
- تومان
- حداقل مبلغ
- ۵۰٬۰۰۰٬۰۰۰
...
- ۵۰٬۰۰۰٬۰۰۰ تومان
- مشاهده در محاسبه‌گر
- پیش از ادامه، ریسک‌های این طرح را بازبینی کنید.
- ادامه
- ۰۲ · مبلغ سرمایه‌گذاری
- Screen/Investment/AmountEntry
- منبع تأمین وجه
- کیف پول داخلی
- موجودی: ۶۰٬۰۰۰٬۰۰۰ تومان
- درگاه پرداخت بانکی
- پرداخت امن از طریق درگاه بانکی
- انتقال بانکی با شناسه واریز
- زمان تأیید: مقدار نمونه
- <re
