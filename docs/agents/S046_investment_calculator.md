# Agent S046 — Screen/Investment/Calculator
...
|---|---|
| Agent ID | `S046` |
| Design path | `Screen/Investment/Calculator` |
| Persian title | محاسبه‌گر |
| Deck file | `../desighn/_capture/06-06-investment-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/calculator_screen.dart` |
| Module | `investment` |
| Note from deck | فقط «برآورد» |
...
```
2. Locate the block for `Screen/Investment/Calculator` / «محاسبه‌گر».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/calculator_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/calculator_screen.dart
flutter analyze lib/features/investment/presentation/screens/calculator_screen.dart
```
