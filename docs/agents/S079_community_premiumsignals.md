# Agent S079 — Screen/Community/PremiumSignals
...
|---|---|
| Agent ID | `S079` |
| Design path | `Screen/Community/PremiumSignals` |
| Persian title | سیگنال‌های اشتراکی |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/premium_signals_screen.dart` |
| Module | `community` |
| Note from deck | طلا محدود به نشان |
...
```
2. Locate the block for `Screen/Community/PremiumSignals` / «سیگنال‌های اشتراکی».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/premium_signals_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/premium_signals_screen.dart
flutter analyze lib/features/community/presentation/screens/premium_signals_screen.dart
```
...
- t-size: 11px; padding: 9px; border-radius: 8px; text-align: center;">مشاهده محتوا
- ۰۹ · سیگنال‌های اشتراکی
- Screen/Community/PremiumSignals · طلا محدود به نشان
- اشتراک‌های من
- فعال
- در انتظار
- پایان‌یافته
...
- تحلیلگر نمونه ۵
- فعال
- ۴۹۰٬۰۰۰ تومان · ماهانه · تمدید: ۱۵ مرداد
- مدیریت
- مشاهده محتوا
- ۱۰ · اشتراک‌های من
- Screen/Community/Subscriptions
- ایجاد تحلیل
- نوع تحلیل
- تکنیکال
- بنیادی
...
- ادامه به ویرایشگر
- ۱۱ · ایجاد تحلیل
- Screen/Community/CreateAnalysis · بدون پیش‌انتخاب افشا
- <div style="height: 51px; flex:
