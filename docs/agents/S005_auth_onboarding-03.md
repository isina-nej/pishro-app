# Agent S005 — Screen/Auth/Onboarding-03
...
|---|---|
| Agent ID | `S005` |
| Design path | `Screen/Auth/Onboarding-03` |
| Persian title | آشنایی ۳ |
| Deck file | `../desighn/_capture/01-03-auth.dc.html` |
| Own file (ONLY write here) | `lib/features/auth/presentation/screens/onboarding_03_screen.dart` |
| Module | `auth` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Auth/Onboarding-03` / «آشنایی ۳».
...
### Phase 2 — Scaffold
1. Create `lib/features/auth/presentation/screens/onboarding_03_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/auth/presentation/screens/onboarding_03_screen.dart
flutter analyze lib/features/auth/presentation/screens/onboarding_03_screen.dart
```
