# Agent S053 — Screen/Investment/ContractConfirmation
...
|---|---|
| Agent ID | `S053` |
| Design path | `Screen/Investment/ContractConfirmation` |
| Persian title | تأیید قرارداد |
| Deck file | `../desighn/_capture/07-06-investment-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/contract_confirmation_screen.dart` |
| Module | `investment` |
...
```
2. Locate the block for `Screen/Investment/ContractConfirmation` / «تأیید قرارداد».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/contract_confirmation_screen.dart` (and directory if needed).
2. Header doc comment:
   `/// Screen/Investment/ContractConfirmation — «تأیید قرارداد».`
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/contract_confirmation_screen.dart
flutter analyze lib/features/investment/presentation/screens/contract_confirmation_screen.dart
```
...
- ۰۵ · تأیید قرارداد
- Screen/Investment/ContractConfirmation · بدون پیش‌انتخاب
- در حال ثبت درخواست
