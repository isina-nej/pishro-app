# Agent S004 — Screen/Auth/Onboarding-02
...
|---|---|
| Agent ID | `S004` |
| Design path | `Screen/Auth/Onboarding-02` |
| Persian title | آشنایی ۲ |
| Deck file | `../desighn/_capture/01-03-auth.dc.html` |
| Own file (ONLY write here) | `lib/features/auth/presentation/screens/onboarding_02_screen.dart` |
| Module | `auth` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Auth/Onboarding-02` / «آشنایی ۲».
...
### Phase 2 — Scaffold
1. Create `lib/features/auth/presentation/screens/onboarding_02_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/auth/presentation/screens/onboarding_02_screen.dart
flutter analyze lib/features/auth/presentation/screens/onboarding_02_screen.dart
```
...
- style="height: 22px; display: grid; place-items: center;">
- ۰۴ · آشنایی ۲
- Screen/Auth/Onboarding-02
- ۹:۴۱
- رد کردن
...
- حداقل مبلغ
- اطلاعات تکمیلی طرح
- طرح هولد با سود داینامیک
- ریسک بالا
- بازدهی داینامیک است و می‌تواند افزایش یا کاهش یابد.
...
- شروع
- ۰۵ · آشنایی ۳
- Screen/Auth/Onboarding-03
- 03_AUTH
- صفحه ۰۶–۰۸ · ورود، ثبت‌نام و تأیید شماره — فرم‌ها تعاملی هستند
- <div style="height:
