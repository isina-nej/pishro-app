# Agent S038 — Screen/News/Comments
...
|---|---|
| Agent ID | `S038` |
| Design path | `Screen/News/Comments` |
| Persian title | دیدگاه‌ها |
| Deck file | `../desighn/_capture/05-05-news.dc.html` |
| Own file (ONLY write here) | `lib/features/news/presentation/screens/comments_screen.dart` |
| Module | `news` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/News/Comments` / «دیدگاه‌ها».
...
### Phase 2 — Scaffold
1. Create `lib/features/news/presentation/screens/comments_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/news/presentation/screens/comments_screen.dart
flutter analyze lib/features/news/presentation/screens/comments_screen.dart
```
...
- کاربر نمونه ۳
- ۱ ساعت پیش
- موافقم، تحلیل جامعی داشت.
- تحریریه پیشرو سرمایه
- ۴۰ دقیقه پیش
- ممنون از همراهی شما.
- مشاهده پاسخ‌های بیشتر
- در پاسخ به کاربر نمونه ۱
- لغو
- پاسخ خود را بنویسید…
- ۰۹ · رشته پاسخ
...
- Screen/News/Saved
- 05_NEWS
- <span style="width: 4px; height: 4px; border
