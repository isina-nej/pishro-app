# Agent S016 — Screen/Checkout/Course-Regular
...
|---|---|
| Agent ID | `S016` |
| Design path | `Screen/Checkout/Course-Regular` |
| Persian title | پرداخت بسته عادی |
| Deck file | `../desighn/_capture/02-04-courses-part-1.dc.html` |
| Own file (ONLY write here) | `lib/features/courses/presentation/screens/course__regular_screen.dart` |
| Module | `courses` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Checkout/Course-Regular` / «پرداخت بسته عادی».
...
### Phase 2 — Scaffold
1. Create `lib/features/courses/presentation/screens/course__regular_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/courses/presentation/screens/course__regular_screen.dart
flutter analyze lib/features/courses/presentation/screens/course__regular_screen.dart
```
...
- مدت دسترسی به گفت‌وگو
- اطلاعات تکمیلی طرح
- سیاست پاسخ‌گویی
- طبق شرایط دوره
- خدمات تکمیلی VIP
- در صورت ارائه توسط مدرس
