# Agent S083 — Screen/Community/AnalysisPreview
...
|---|---|
| Agent ID | `S083` |
| Design path | `Screen/Community/AnalysisPreview` |
| Persian title | پیش‌نمایش تحلیل |
| Deck file | `../desighn/_capture/09-08-community.dc.html` |
| Own file (ONLY write here) | `lib/features/community/presentation/screens/analysis_preview_screen.dart` |
| Module | `community` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Community/AnalysisPreview` / «پیش‌نمایش تحلیل».
...
### Phase 2 — Scaffold
1. Create `lib/features/community/presentation/screens/analysis_preview_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/community/presentation/screens/analysis_preview_screen.dart
flutter analyze lib/features/community/presentation/screens/analysis_preview_screen.dart
```
