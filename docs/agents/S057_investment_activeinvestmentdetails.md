# Agent S057 — Screen/Investment/ActiveInvestmentDetails
...
|---|---|
| Agent ID | `S057` |
| Design path | `Screen/Investment/ActiveInvestmentDetails` |
| Persian title | جزئیات سرمایه‌گذاری |
| Deck file | `../desighn/_capture/07-06-investment-part-2.dc.html` |
| Own file (ONLY write here) | `lib/features/investment/presentation/screens/active_investment_details_screen.dart` |
| Module | `investment` |
| Note from deck | — |
...
```
2. Locate the block for `Screen/Investment/ActiveInvestmentDetails` / «جزئیات سرمایه‌گذاری».
...
### Phase 2 — Scaffold
1. Create `lib/features/investment/presentation/screens/active_investment_details_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/investment/presentation/screens/active_investment_details_screen.dart
flutter analyze lib/features/investment/presentation/screens/active_investment_details_screen.dart
```
...
- /div>
- آخرین به‌روزرسانی داده: امروز، ۹:۴۰
- ۰۹ · جزئیات سرمایه‌گذاری
- Screen/Investment/ActiveInvestmentDetails
- برنامه پرداخت
- دریافت ماهیانه ۸٪ · ۵۰٬۰۰۰٬۰۰۰ تومان
- ۱ مرداد ۱۴۰۵
- مرجع: PAY-1042
- ۴٬۰۰۰٬۰۰۰ تومان
- پرداخت‌شده
