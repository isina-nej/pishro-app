# Agent S037 — Screen/News/Details
...
|---|---|
| Agent ID | `S037` |
| Design path | `Screen/News/Details` |
| Persian title | جزئیات خبر |
| Deck file | `../desighn/_capture/05-05-news.dc.html` |
| Own file (ONLY write here) | `lib/features/news/presentation/screens/details_screen.dart` |
| Module | `news` |
| Note from deck | متن ۱۵px+ |
...
```
2. Locate the block for `Screen/News/Details` / «جزئیات خبر».
...
### Phase 2 — Scaffold
1. Create `lib/features/news/presentation/screens/details_screen.dart` (and directory if needed).
...
### Phase 5 — Verify
```bash
dart format lib/features/news/presentation/screens/details_screen.dart
flutter analyze lib/features/news/presentation/screens/details_screen.dart
```
...
- ight: 600; color: #D9DEE3;">دیدگاه‌ها (۲۸)
- مشاهده همه
- ۰۷ · جزئیات خبر
...
- پاسخ خود را بنویسید…
- ۰۹ · رشته پاسخ
- <div style="font-family: 'IBM Plex Mono', monospace; font-
